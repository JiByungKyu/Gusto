...
/**
 * Created by YJ on 2017-09-28.
 */

public class AnalogDataProcess implements DataProcessor{
    private static AnalogDataProcess analogDataProcess;
    private String[] analogParsedData;
    private HashMap<Byte,Object> processedData;
    private AnalogDataProcess(){
        analogParsedData = null;
    }

    public static AnalogDataProcess getInstance(){
        if(analogDataProcess == null){
            analogDataProcess = new AnalogDataProcess();
        }
        return analogDataProcess;
    }
    ...
    public void analogDataProcessing(int[] analogParsedData) {
        ...
        Log.i("아날로그","왓어"+analogParsedData.length);
